...
아래 식은 PID 제어를 표현하는 가장 기본적인 식입니다. 아래 식을 살펴보면, 최종 출력 ${u}_t$는 목표 상태 ${x}_g$와 현재 상태 ${x}_t$의 차이, ${e}_t$에 의해서 결정되는 것을 알 수 있습니다. 즉, PID 제어는 목표 상태와 현재 상태를 가장 최단거리로 잇는 경로 위에서만 동작합니다. [[1]](#ref_1)
...
<center><img src="https://user-images.githubusercontent.com/16010242/69508458-1c640d80-0f79-11ea-9c46-c71f3f8fcd99.png" width="90%"></center>[[6]](#ref_6)
